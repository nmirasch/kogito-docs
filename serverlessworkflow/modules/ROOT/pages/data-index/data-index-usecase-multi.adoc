...
You can directly access the UseCase1 example application we are going to follow at link:{flow_examples_operator_url}[SonataFlow Use Cases repository].
